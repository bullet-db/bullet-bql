...
public enum QueryError {
    ...
    EXPECTED_PRIMITIVE_TYPES("The types of the arguments in %s must be primitive. Type given: %s"),
    ...
    RHS_NOT_A_LIST("The right operand in %s must be some LIST. Type given: %s"),
    LHS_AND_SUBTYPE_OF_RHS_NOT_COMPARABLE("The type of the left operand and the subtype of the right operand in %s must be comparable. Types given: %s, %s"),
    LHS_NOT_NUMERIC("The left operand in %s must be numeric. Type given: %s"),
    RHS_NOT_NUMERIC("The right operand in %s must be numeric. Type given: %s"),
    RHS_NOT_NUMERIC_LIST("The right operand in %s must be some numeric LIST. Type given: %s"),
    BINARY_TYPES_NOT_STRING("The types of the arguments in %s must be STRING. Types given: %s, %s"),
    LHS_NOT_STRING("The type of the left operand in %s must be STRING. Type given: %s"),
    RHS_NOT_STRING_LIST("The type of the right operand in %s must be STRING_LIST. Type given: %s"),
    ...
    CONTAINS_KEY_NOT_NUMERIC("The type of the second argument in %s must be STRING. Type given: %s"),
    ...
    IN_NOT_PRIMITIVE("The type of the left operand in %s must be primitive. Type given: %s"),
    IN_NOT_LIST_OR_MAP("The type of the right operand in %s must be some LIST or MAP. Type given: %s"),
    ...
    LOGICAL_ARGUMENTS_NOT_BOOLEAN("The types of the arguments in %s must be BOOLEAN. Types given: %s, %s"),
