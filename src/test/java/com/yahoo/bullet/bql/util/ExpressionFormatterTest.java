...
public class ExpressionFormatterTest {
    ...
    public void testEverything() {
        ...
        Assert.assertEquals(ExpressionFormatter.format(queryNode), "SELECT DISTINCT a, b AS c FROM STREAM(max, TIME) WHERE d GROUP BY e HAVING f ORDER BY g ASC, h DESC WINDOWING EVERY(1, TIME, FIRST, 1, TIME) LIMIT 1");
    }
